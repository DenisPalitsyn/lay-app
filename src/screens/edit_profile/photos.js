...
// import {ActivityIndicator, Button, Text, RadioButton, Card} from 'react-native-paper';
...
export const Photos = () => {
  ...
  console.log('whyAddPhoto', whyAddPhoto);
  //
  ...
  //   mainPhoto === i && newValue && setValidMainPhoto(newPhotos);
  // }
  //
  ...
  //     const fetchData = async () => dispatch(getGalleryPhotos(profile.id, 'L'));
