...
//   useEffect(() => {
//     let Mounted = true;
//     if (profileIsLoaded && initialPhotosGallery && !initialPhotosGallery.length && !photosGalleryIsLoaded) {
...
//       Mounted = false;
//     }
//   }, [profileIsLoaded, profileUid, initialPhotosGallery, photosGalleryIsLoaded]);
//
//   useEffect(() => {
//     let Mounted = true;
